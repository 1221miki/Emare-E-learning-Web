...
const inVideoQuizRoutes = require('./routes/inVideoQuizRoutes');
...
app.use('/api/in-video-quiz', inVideoQuizRoutes);
...
app.use('/api/admin/contact-messages', protect, authorizeRoles('Admin'), adminContactMessageRoutes);
