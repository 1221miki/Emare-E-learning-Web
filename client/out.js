(() => {
  ...
  var AuthProvider = ({ children }) => {
    ...
    const login = (0, import_react.useCallback)(async (accountEmail, securedPassword) => {
    ...
    const register = (0, import_react.useCallback)(async (formData) => {
    ...
    const socialAuth = (0, import_react.useCallback)(async (providerData) => {
    ...
    const requestPasswordReset = (0, import_react.useCallback)(async (accountEmail) => {
      const { data } = await authService.forgotPassword({ accountEmail });
      return data;
    }, []);
    const resetPassword = (0, import_react.useCallback)(async (resetToken, newPassword) => {
    ...
    return /* @__PURE__ */ import_react.default.createElement(AuthContext.Provider, { value }, !loading && children);
  };
})();
