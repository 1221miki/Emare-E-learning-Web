    ...
    if (!event) {
        return shell(
            <main className="relative z-10 mx-auto flex max-w-7xl flex-col items-center justify-center px-4 pb-24 pt-40 text-center sm:px-6">
                ...
                <Link
                    to="/events"
                    className="mt-8 inline-flex items-center gap-2 rounded-2xl bg-gradient-to-r from-blue-400 to-violet-500 px-6 py-3 text-sm font-extrabold uppercase tracking-wide text-black shadow-[0_0_25px_rgba(96,165,250,0.4)] transition hover:brightness-110"
                >
    ...
    return shell(
        <>
            <main className="relative z-10 mx-auto max-w-7xl px-4 pt-24 sm:px-6 sm:pt-28">
                ...
                <Link
                    to="/events"
                    className="inline-flex items-center gap-2 text-sm font-bold text-gray-300 transition hover:text-blue-400"
                >
                    <ArrowLeft className="h-4 w-4" /> Back to Events
                </Link>

                {/* ── Hero / Banner ──────────────────────────────────────── */}
                <section className="relative mt-6 overflow-hidden rounded-3xl border border-blue-500/20">
                    ...
                    <div className="relative flex min-h-[320px] flex-col justify-end gap-5 px-6 py-10 sm:min-h-[380px] sm:px-12 sm:py-12">
                        ...
                        <div className="flex flex-wrap items-center gap-x-6 gap-y-3 text-sm text-gray-200">
                            <span className="flex items-center gap-2"><Calendar className="h-4 w-4 text-blue-400" /> {eventDateISO}</span>
                            <span className="flex items-center gap-2"><Clock className="h-4 w-4 text-blue-400" /> {event.time}</span>
                            <span className="flex items-center gap-2"><MapPin className="h-4 w-4 text-blue-400" /> {event.location}</span>
                        </div>
                        ...
                        <div className="flex flex-wrap gap-3">
                            {[
                                ...
                                <div key={b.label} className="flex min-w-[76px] flex-col items-center rounded-2xl border border-blue-500/25 bg-black/40 px-4 py-3 backdrop-blur">
                                    <span className="text-2xl font-black tabular-nums text-white">{padCount(b.value)}</span>
                                    <span className="mt-1 text-[10px] font-extrabold uppercase tracking-[0.2em] text-blue-400">{b.label}</span>
                                </div>
                            ))}
                        </div>
                        ...
                        <div className="flex flex-col gap-4 border-t border-white/10 pt-5 sm:flex-row sm:items-end sm:justify-between">
                            {isCancelled ? (
                                ...
                                <button
                                    ...
                                    className="inline-flex w-fit items-center justify-center gap-2 rounded-2xl bg-gradient-to-r from-blue-400 to-violet-500 px-8 py-4 text-sm font-extrabold uppercase tracking-wide text-black shadow-[0_0_30px_rgba(96,165,250,0.45)] transition hover:shadow-[0_0_45px_rgba(96,165,250,0.6)]"
                                >
                                    Register Now <ArrowRight className="h-4 w-4" />
                                </button>
                            )}
                            <div className="w-full sm:w-52">
                                <span className="inline-flex items-center gap-2 text-xs font-semibold text-blue-300">
                ...
                <section className="mt-16 grid gap-8 lg:grid-cols-3">
                    <div className="lg:col-span-2">
                        <div className="mb-4 flex items-center gap-3">
                            <span className="text-xs font-extrabold uppercase tracking-[0.25em] text-blue-400">About The Event</span>
                        ...
                        <div className="mt-6 rounded-2xl border border-blue-500/20 bg-[#12131A] p-5">
                            <p className="text-xs font-extrabold uppercase tracking-[0.25em] text-blue-400">Localized Schedule</p>
                        ...
                        <div className="mt-6 grid gap-3 sm:grid-cols-2">
                            <div className="flex items-center gap-3 rounded-2xl border border-blue-500/20 bg-[#12131A] p-4">
                                <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-blue-400/10 text-blue-400"><CalendarDays className="h-5 w-5" /></span>
                                <div>
                            ...
                            <div className="flex items-center gap-3 rounded-2xl border border-blue-500/20 bg-[#12131A] p-4">
                                <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-blue-400/10 text-blue-400"><Clock className="h-5 w-5" /></span>
                                <div>
                            ...
                            <div className="flex items-center gap-3 rounded-2xl border border-blue-500/20 bg-[#12131A] p-4 sm:col-span-2">
                                <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-blue-400/10 text-blue-400"><MapPin className="h-5 w-5" /></span>
                                <div>
                        ...
                        {event.speaker && (
                            <div className="mt-8 rounded-3xl border border-blue-500/20 bg-[#12131A] p-6">
                                <span className="text-xs font-extrabold uppercase tracking-[0.25em] text-blue-400">Organizer / Speaker</span>
                                <div className="mt-5 flex flex-col gap-4 sm:flex-row sm:items-center">
                                    <img src={event.speaker.avatar} alt={event.speaker.name} className="h-16 w-16 shrink-0 rounded-2xl border border-blue-500/20 object-cover" />
                                    <div>
                                        <p className="flex items-center gap-2 text-lg font-extrabold text-white">
                                            <BadgeCheck className="h-5 w-5 text-blue-400" /> {event.speaker.name}
                                        </p>
                                        <p className="text-xs font-bold uppercase tracking-wider text-blue-300">{event.speaker.role}</p>
                    ...
                    <aside className="flex flex-col gap-6">
                        <div className="rounded-3xl border border-blue-500/20 bg-[#12131A] p-6">
                            <h3 className="mb-5 text-xs font-extrabold uppercase tracking-[0.25em] text-blue-400">Event Info</h3>
                            <div className="space-y-4 text-sm">
                                ...
                                <div className="flex items-center justify-between rounded-2xl border border-blue-500/20 bg-[#1A1B23] px-4 py-3">
                                    <span className="flex items-center gap-2 font-semibold text-gray-200"><Tag className="h-4 w-4 text-blue-400" /> Price</span>
                                    <span className="rounded-full bg-blue-400 px-3 py-1 text-xs font-extrabold text-black">{event.price}</span>
                                </div>
                                <div className="flex items-center justify-between rounded-2xl border border-blue-500/20 bg-[#1A1B23] px-4 py-3">
                                    <span className="flex items-center gap-2 font-semibold text-gray-200"><Users className="h-4 w-4 text-blue-400" /> Remaining</span>
                                    <span className="text-xs font-extrabold text-blue-300">{event.slotsLeft} spots</span>
                                </div>
                            </div>
                            {isCancelled ? (
                                ...
                                <div className="mt-6 flex w-full flex-col gap-2">
                                    ...
                                    <button onClick={copyMeetingLink} className="flex w-full items-center justify-center gap-2 rounded-xl border border-blue-400/40 bg-blue-400/10 py-2.5 text-xs font-bold uppercase tracking-wide text-blue-300 transition hover:bg-blue-400/20">
                                        Copy Meeting Link
                                    </button>
                                    {event.meetingPassword && (
                                        <div className="rounded-lg border border-white/10 bg-white/5 px-3 py-2 text-center text-xs text-gray-300">
                                            Meeting password: <span className="font-mono font-bold text-blue-300">{event.meetingPassword}</span>
                                        </div>
                                    )}
                                </div>
                            ) : (
                                <button
                                    onClick={scrollToSecureSpot}
                                    className="mt-6 w-full rounded-xl bg-gradient-to-r from-blue-400 to-violet-500 py-3 text-sm font-extrabold uppercase tracking-wide text-black transition hover:brightness-110"
                                >
                                    Register Now
                                </button>
                            )}
                        ...
                        <div className="rounded-3xl border border-blue-500/20 bg-[#12131A] p-6">
                            <h3 className="mb-5 text-xs font-extrabold uppercase tracking-[0.25em] text-blue-400">Upcoming Events</h3>
                            <div className="space-y-4">
                                {otherEvents.map((e) => (
                                        <Link
                                            key={e.id}
                                            to={`/events/${e.id}`}
                                            className="group flex items-center gap-4 rounded-2xl border border-white/5 bg-[#1A1B23] p-3 transition hover:border-blue-400/40"
                                        >
                                            <img src={e.image} alt={e.title} className="h-14 w-14 shrink-0 rounded-xl border border-blue-500/20 object-cover" />
                                            <div className="min-w-0 flex-1">
                                                <p className="truncate text-sm font-bold text-white group-hover:text-blue-300">{e.title}</p>
                                                <p className="mt-1 text-xs text-gray-400">{formatISODate(e.date)} · {e.time}</p>
                                            </div>
                                            <span className="inline-flex shrink-0 items-center gap-1 text-[11px] font-extrabold uppercase tracking-wider text-blue-400 transition group-hover:gap-2">
                ...
                <section className="mt-20">
                    <div className="mb-6 flex items-center gap-3">
                        <span className="text-xs font-extrabold uppercase tracking-[0.25em] text-blue-400">Moments From Our Events</span>
                        <span className="h-px flex-1 bg-gradient-to-r from-blue-400/50 to-transparent" />
                    </div>
                    <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                        <div className="group relative overflow-hidden rounded-3xl border border-blue-500/20 sm:row-span-2">
                            ...
                            <span className="absolute bottom-4 left-4 flex items-center gap-2 rounded-full bg-black/50 px-3 py-1 text-xs font-semibold text-white backdrop-blur">
                                <Camera className="h-3.5 w-3.5 text-blue-400" /> {eventGallery[0].label}
                            </span>
                        </div>
                        {eventGallery.slice(1).map((g) => (
                            <div key={g.label} className="group relative overflow-hidden rounded-3xl border border-blue-500/20">
                                <img src={g.src} alt={g.label} className="h-48 w-full object-cover transition duration-500 group-hover:scale-105" />
                                <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-transparent to-transparent opacity-70 transition group-hover:opacity-100" />
                                <span className="absolute bottom-4 left-4 flex items-center gap-2 rounded-full bg-black/50 px-3 py-1 text-xs font-semibold text-white backdrop-blur">
                                    <Camera className="h-3.5 w-3.5 text-blue-400" /> {g.label}
                                </span>
                            </div>
                        ))}
                    </div>
                ...
                <section id="secure-your-spot" className="mt-20 scroll-mt-28">
                    <div className="mb-2 text-center">
                        <span className="text-xs font-extrabold uppercase tracking-[0.25em] text-blue-400">Secure Your Spot</span>
                    </div>
                    ...
                    {isCancelled || isCompleted ? (
                        <div className="mt-10 overflow-hidden rounded-3xl border border-blue-500/20 bg-[#12131A] p-10 text-center shadow-[0_0_40px_rgba(96,165,250,0.07)]">
                            ...
                            <Link to="/events" className="mt-6 inline-flex items-center gap-2 rounded-2xl bg-gradient-to-r from-blue-400 to-violet-500 px-6 py-3 text-sm font-extrabold uppercase tracking-wide text-black transition hover:brightness-110">
                                Browse Upcoming Events <ArrowRight className="h-4 w-4" />
                            </Link>
                        </div>
                    ) : (
                    <div className="mt-10 overflow-hidden rounded-3xl border border-blue-500/20 bg-[#12131A] shadow-[0_0_40px_rgba(96,165,250,0.07)]">
                        <div className="h-1.5 w-full bg-gradient-to-r from-blue-500 via-violet-500 to-blue-500" />
                        <div className="grid gap-6 p-6 sm:p-8 lg:grid-cols-[1fr_1.1fr]">
                            ...
                            <p className="mt-6 mb-2 text-xs font-bold uppercase tracking-widest text-blue-300">Time Slot</p>
                                ...
                                {TIME_SLOTS.map((t) => (
                                    <button
                                        ...
                                        className={`rounded-xl px-5 py-2.5 text-sm font-bold transition ${
                                            selectedSlot === t
                                                ? 'bg-gradient-to-r from-blue-400 to-violet-500 text-black shadow-[0_0_18px_rgba(96,165,250,0.4)]'
                                                : 'border border-white/10 text-gray-300 hover:border-blue-400/50 hover:text-blue-300'
                                        }`}
                                    >
                                        {t}
                                    </button>
                            ...
                            <p className="mt-6 mb-3 text-xs font-bold uppercase tracking-widest text-blue-300">Personal Details</p>
                            ...
                            <form className="grid gap-4 sm:grid-cols-2" onSubmit={(e) => { e.preventDefault(); handleConfirm(); }}>
                                <div className="sm:col-span-2">
                                    ...
                                    <input
                                        ...
                                        className="w-full rounded-xl border border-blue-500/20 bg-[#1A1B23] px-4 py-3 text-sm text-white placeholder-gray-500 transition focus:border-blue-400 focus:ring-2 focus:ring-blue-400/30 focus:outline-none"
                                    />
                                </div>
                                <div>
                                ...
                                <button
                                    type="submit"
                                    disabled={submitting}
                                    className="mt-2 flex w-full items-center justify-center gap-2 rounded-2xl bg-gradient-to-r from-blue-400 to-violet-500 py-4 text-sm font-extrabold uppercase tracking-wide text-black shadow-[0_0_30px_rgba(96,165,250,0.4)] transition hover:shadow-[0_0_45px_rgba(96,165,250,0.6)] disabled:cursor-not-allowed disabled:opacity-60 sm:col-span-2"
                                >
            ...
            {modal && (
                <div className="fixed inset-0 z-[60] flex items-center justify-center px-4">
                    ...
                    <div className="relative w-full max-w-md rounded-3xl border border-blue-500/25 bg-[#12131A] p-8 shadow-[0_0_60px_rgba(96,165,250,0.15)]">
                        ...
                        {modal.view === 'linkCopied' ? (
                            <>
                                <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-blue-400/15 shadow-[0_0_35px_rgba(96,165,250,0.4)]">
                                ...
                                <button
                                    onClick={closeModal}
                                    className="mt-6 w-full rounded-2xl border border-blue-400/40 bg-blue-400/10 py-3.5 text-sm font-extrabold uppercase tracking-wide text-blue-300 transition hover:bg-blue-400/20"
                                >
                                    Done
                                </button>
                            </>
                        ...
                        {modal.warning && (
                            <div className="mt-4 flex items-start gap-2.5 rounded-2xl border border-blue-400/40 bg-blue-400/10 p-4 text-sm text-blue-200">
                        ...
                        <div className="mt-6 space-y-3 rounded-2xl border border-white/5 bg-[#1A1B23] p-5 text-sm">
                            <div className="flex items-center justify-between">
                                ...
                                <span className="font-mono font-bold text-blue-300">{bookingRef}</span>
                            </div>
                            <div className="flex items-center justify-between">
