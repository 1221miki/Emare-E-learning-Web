...
const styles = {
    ...
    stepItem: { display: 'flex', alignItems: 'center', gap: 12, padding: 16, borderRadius: 16, background: 'var(--emare-bg-card)', border: '1px solid var(--emare-border)', boxShadow: '0 1px 2px rgba(15, 23, 42, 0.04)' },
    ...
    label: { color: 'var(--emare-text-muted)', fontSize: 12, fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.04em' },
    input: { background: 'var(--emare-bg-card)', border: '1px solid var(--emare-border)', borderRadius: 10, color: 'var(--emare-text)', padding: '11px 13px', fontSize: 14, outline: 'none', width: '100%', boxSizing: 'border-box', boxShadow: 'inset 0 1px 0 rgba(255,255,255,0.04)' },
    panel: { display: 'flex', flexDirection: 'column', gap: 18 },
    sectionTitle: { fontSize: 17, color: 'var(--emare-text)', margin: 0, fontWeight: 700 },
    sectionSubtitle: { color: 'var(--emare-text-muted)', fontSize: 13, margin: 0, lineHeight: 1.6 },
    secondaryBtn: { background: 'rgba(21,128,61,0.08)', border: '1px solid rgba(21,128,61,0.35)', color: 'var(--emare-primary)', borderRadius: 12, padding: '11px 16px', cursor: 'pointer', fontWeight: 700, display: 'inline-flex', alignItems: 'center', gap: 7, fontSize: 13 },
    primaryBtn: { background: 'linear-gradient(135deg, var(--emare-primary), var(--emare-accent))', border: 'none', borderRadius: 12, color: '#fff', padding: '11px 16px', cursor: 'pointer', fontWeight: 700, display: 'inline-flex', alignItems: 'center', gap: 7, fontSize: 13, boxShadow: '0 8px 18px rgba(21, 128, 61, 0.22)' },
    emptyBox: { padding: 24, borderRadius: 16, background: 'var(--emare-bg)', border: '1px dashed var(--emare-border)', color: 'var(--emare-text-muted)', lineHeight: 1.7 },
    chapterCard: { background: 'var(--emare-bg-card)', border: '1px solid var(--emare-border)', borderRadius: 18, padding: 18, display: 'flex', flexDirection: 'column', gap: 14, boxShadow: '0 1px 2px rgba(15, 23, 42, 0.04)' },
    chapterHeader: { display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: 12 },
    lessonRow: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: 10, padding: '10px 14px', borderRadius: 12, background: 'var(--emare-bg)', border: '1px solid var(--emare-border)' },
    badge: { padding: '3px 10px', borderRadius: 999, background: 'rgba(22,163,74,0.12)', color: 'var(--emare-primary)', fontSize: 11, fontWeight: 700, whiteSpace: 'nowrap' },
    reviewGrid: { display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 18 },
    panelCard: { padding: 20, borderRadius: 18, border: '1px solid var(--emare-border)', background: 'var(--emare-bg-card)' },
    summaryRow: { display: 'flex', justifyContent: 'space-between', gap: 12, marginBottom: 10, color: 'var(--emare-text)', fontSize: 14 },
    chapterSummary: { padding: 12, borderRadius: 12, border: '1px solid var(--emare-border)', marginBottom: 10, background: 'var(--emare-bg)' },
    lessonSummary: { display: 'flex', justifyContent: 'space-between', marginTop: 8, color: 'var(--emare-text-muted)', fontSize: 13 },
    fileInput: { border: 'none', color: 'var(--emare-text)', marginTop: 8 },
    preview: { marginTop: 8, color: 'var(--emare-primary)', fontSize: 13, fontWeight: 600 },
    textBtn: { border: 'none', background: 'transparent', color: 'var(--emare-primary)', fontWeight: 700, cursor: 'pointer', display: 'inline-flex', alignItems: 'center', gap: 4, fontSize: 13 },
    card: { background: 'var(--emare-bg-card)', border: '1px solid var(--emare-border)', borderRadius: 18, padding: 20, display: 'flex', flexDirection: 'column', gap: 12, boxShadow: '0 1px 2px rgba(15, 23, 42, 0.04)' },
    cardHeader: { display: 'flex', alignItems: 'center', gap: 10, color: 'var(--emare-text)', fontWeight: 700 },
    cardTitle: { fontSize: 15 },
    cardDescription: { color: 'var(--emare-text-muted)', fontSize: 13, margin: 0 },
    emptyText: { color: 'var(--emare-text-muted)', fontSize: 14 },
