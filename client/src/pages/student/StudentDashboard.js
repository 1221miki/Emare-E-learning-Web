...
const styles = {
    page: { display: 'flex', minHeight: '100vh', background: 'linear-gradient(rgba(9, 13, 22, 0.7), rgba(9, 13, 22, 0.7)), url("/images/dashboard-bg.jpg") no-repeat center center fixed', backgroundSize: 'cover', fontFamily: "'Outfit', sans-serif" },
    sidebar: { width: '260px', background: 'rgba(15, 20, 34, 0.65)', backdropFilter: 'blur(12px)', borderRight: '1px solid rgba(30, 41, 59, 0.5)', display: 'flex', flexDirection: 'column', padding: '24px 16px', position: 'fixed', height: '100vh', zIndex: 10 },
    ...
    statCard: { background: 'rgba(14, 23, 38, 0.65)', backdropFilter: 'blur(10px)', borderRadius: '16px', padding: '24px', border: '1px solid rgba(30, 41, 59, 0.5)' },
    ...
    panelCard: { background: 'rgba(14, 23, 38, 0.65)', backdropFilter: 'blur(10px)', borderRadius: '16px', padding: '32px', border: '1px solid rgba(30, 41, 59, 0.5)', marginBottom: '32px' },
    ...
    courseCard: { background: 'rgba(14, 23, 38, 0.65)', backdropFilter: 'blur(10px)', borderRadius: '16px', padding: '24px', border: '1px solid rgba(30, 41, 59, 0.5)', display: 'flex', flexDirection: 'column' },
    ...
    tableCard: { background: 'rgba(14, 23, 38, 0.65)', backdropFilter: 'blur(10px)', borderRadius: '16px', border: '1px solid rgba(30, 41, 59, 0.5)', overflow: 'hidden' },
    ...
    certCard: { background: 'rgba(14, 23, 38, 0.65)', backdropFilter: 'blur(10px)', borderRadius: '16px', padding: '32px', border: '1px solid rgba(30, 41, 59, 0.5)', textAlign: 'center' },
